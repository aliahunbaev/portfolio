...
export default function WorkIndex({ works }: { works: Project[] }) {
  ...
  return (
    <div>
      ...
      {active && (
        <div className="pointer-events-none fixed bottom-gutter right-gutter z-30 w-[38vw] min-w-[420px] max-md:min-w-0 max-md:left-gutter max-md:w-auto [@media(hover:none)]:hidden">
