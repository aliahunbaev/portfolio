            ...
            <div className="w-full lg:w-[60%]">
              <div className="bg-white rounded-2xl p-6 md:p-4 h-full flex" style={{ boxShadow: '0 0 20px rgba(0, 0, 0, 0.06)' }}>
                ...
                >
                  ...
                  <p className="text-base text-gray-700 leading-normal mb-4" style={{ fontFamily: 'Helvetica Neue, Helvetica, Arial, sans-serif' }}>
                    I started drawing portraits of my mom when I was 3, and quickly got labeled as &quot;the artist&quot; by everyone around me. I got lucky with that label - it shaped how I see the world and myself.
                  </p>
                  ...
                  <p className="text-base text-gray-700 leading-normal" style={{ fontFamily: 'Helvetica Neue, Helvetica, Arial, sans-serif' }}>
